...
class AsciiArtGenerator:
    ...
    def animate(self, max_generations=None, delay=0.5):
        ...
        try:
            ...
            print(f"Generations: {len(data['frames'])}/11 | Remaining today: {data.get('remaining_today', 0)}")
            ...
            for i, frame in enumerate(data["frames"]):
                ...
                print(f"Generation: {frame['generation']}/{len(data['frames'])} | Remaining today: {data.get('remaining_today', 0)}")
                print("=" * 80)
                print(frame["art"])
                print("=" * 80)
            ...
            if rate_info:
                print(f"Daily limit resets: {rate_info.get('reset_time', 'in 24 hours')}")
